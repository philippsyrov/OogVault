...
(function () {
    ...
    function extractMessages() {
        ...
        const articles = document.querySelectorAll('main article, main [data-testid*="conversation-turn"]');
    ...
    function extractTextContent(element) {
        ...
        clone
            .querySelectorAll('button, [role="toolbar"], nav, header, footer, [class*="toolbar"], [class*="action"]')
